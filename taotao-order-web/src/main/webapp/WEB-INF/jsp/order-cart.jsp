...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="zm"/>
		...
		<input type="hidden" name="orderShipping.receiverDistrict" value="都江堰"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="聚源镇"/>
</form>
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">zm</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">158****8888</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">四川成都都江堰</div>
						<div class="adr-m" limit="30">聚源镇</div>
